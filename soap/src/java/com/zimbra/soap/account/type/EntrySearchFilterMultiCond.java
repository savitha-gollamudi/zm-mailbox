...
implements SearchFilterCondition {
    ...
    public void setSingleConditions(Iterable <EntrySearchFilterSingleCond> conditions) {
        if (conditions != null) {
            Iterables.addAll(this.conditions, conditions);
        }
    }
    ...
    public void setMultipleConditions(Iterable <EntrySearchFilterMultiCond> conditions) {
        if (conditions != null) {
            Iterables.addAll(this.conditions, conditions);
        }
    }
